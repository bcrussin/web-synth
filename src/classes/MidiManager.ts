...
import type MidiChannel from './MidiAssignment'
import { getAudioStore } from '@/stores/audioStore'
import type { IMidiAssignment, MidiAssignmentFilters } from './MidiAssignment'
export default class MidiManager {
	// static registerAssignment(assignment: IMidiAssignment) {
	// 	const deviceName = assignment.device.name
	...
	// 		// }
	// 	}
	// 	getAudioStore().midiAssignments.set(assignment.id, assignment)
	// }
	// static unregisterChannel(assignment: IMidiAssignment) {
	// 	const deviceName = assignment.device.name
	// 	if (assignment.isGlobal) {
	// 		getAudioStore().globalMidiChannels.delete(deviceName)
	// 	} else {
	// 		// getAudioStore().globalMidiChannels
	// 		// for (const synthId of channel.synth.id) {
	...
	// 		// }
	// 	}
	// 	getAudioStore().midiAssignments.delete(assignment.id)
	// }
